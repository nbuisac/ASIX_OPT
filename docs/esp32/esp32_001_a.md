...
## Visual Studio Code - *Pymakr* i *Pymakr - Preview*

El *Visual Studio Code* té moltes extensions per treballar amb qualsevol tipus de llenguate i com no podia faltar també té extensions per a treballar amb microPython i permetre la connectivitat amb el nostre dispositiu. Necessitarem dues extensions que son:

* [Pymakr][]

* [Pymakr - Preview][]

Podem instal·lar-les des del Visual Studio Code, cercant extensions de nom **Pymakr**

![extensions.png][]

Una vegada instal·lades caldrà anar a la seva icona per a crear els diferents projectes.
...
Això només cal fer-ho una sola vegada. Pots trobar informació a la pàgina de [MicroPython][]. Cal buscar el tipus de controladora, en el nostre cas [ESP32-S3][] amb *Support for Octal-SPIRAM*, i seguir les instruccions.
...
* eliminar la flash de la microcontroladora
    ...
    ```doscon
    py -m esptool -p COM3 erase-flash
    ```

* carregar el microPython

    ```doscon
    py -m esptool -p COM3 --baud 460800 write-flash 0 ESP32_GENERIC_S3-SPIRAM_OCT-20250911-v1.26.1.bin
    ```
...
[extensions.png]:   ./img/extensions.png "Extensions pymakr"
